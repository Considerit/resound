...
def trim_and_concat_video(
    ...
    if extend_by > 0:
        ...
        if (
            end + fill_length + extend_by <= reaction_video.duration
        ):  # Make sure not to exceed the reaction video duration
    ...
    # If final_clip is shorter than base_video, pad it with black frames
        ...
        black_clip = (
            ColorClip((base_video.size), col=(0, 0, 0))
